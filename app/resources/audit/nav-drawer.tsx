            ...
            <div className="max-w-md m-auto w-full">
              ...
              <div className="text-foreground mb-2">
                <ol className="space-y-2 py-6">
                  <ToCLink pageNumber={2} text="Document Overview" />
                  <ToCLink pageNumber={3} text="Audit Summary" />
                  <ToCLink pageNumber={6} text="System Overview" />
                  <ToCLink pageNumber={8} text="Findings (Medium)" />
                  <ToCLink pageNumber={14} text="Findings (Low)" />
                  <ToCLink pageNumber={22} text="Findings (Info)" />
                  <ToCLink pageNumber={29} text="Disclaimers" />
                  <ToCLink pageNumber={30} text="Severity Definitions" />
                  <ToCLink pageNumber={31} text="Scope" />
                </ol>
                <Link
                  href="/resources"
