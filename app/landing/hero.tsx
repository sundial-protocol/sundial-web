...
export function OrbitTrace({ size }: { size: number }) {
  return (
    <div
      style={{
        padding: `${size}px`,
      ...
      beams={[
        ...
        },
        {
          styles: {
            ...
            top: "0",
            width: "100%",
            height: "2200px", // Match the height of the triangle
            background:
              "linear-gradient(to bottom left, rgba(255, 183, 11, 1) 0%, rgba(255, 183, 11, 1) 30%, rgba(0, 0, 0, 0) 50%, rgba(0, 0, 0, 0) 100%)", // Gradient from orange to black
            clipPath: "polygon(0% 0%, 40% 0%, 100% 100%)", // Triangle shape
            zIndex: "-1",
            opacity: "0.3",
          },
        },
    ...
    >
      <HeroSection classes="bg-transparent">
        <div className="flex flex-col items-center justify-center space-y-4 text-center">
          ...
          <Link
            href="/stake"
            className="inline-flex items-center justify-center bg-primary text-black h-12 px-8 text-base font-medium hover:bg-primary/80 transition-all"
          >
            Start Staking
