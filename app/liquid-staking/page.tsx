          ...
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl">
                Stake your Bitcoin while maintaining liquidity with
          ...
          <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
            <div className="space-y-4">
              ...
              <p className="text-gray-500 md:text-lg">
                Liquid staking allows you to stake your Bitcoin while receiving
                a liquid token ($SUN) that represents your staked assets. This
                means you can use your staked Bitcoin in DeFi applications while
                still earning staking rewards.
              </p>
              <p className="text-gray-500 md:text-lg">
                With Sundial&apos;s liquid staking, you get the best of both
                worlds: the security and rewards of staking, plus the
                flexibility and liquidity of having tradable tokens.
              </p>
            </div>
          ...
          <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
            <div className="space-y-2">
              ...
              <p className="mx-auto max-w-[700px] text-gray-500 md:text-lg">
                Sundial&apos;s liquid staking process is simple and
                user-friendly.
              </p>
            </div>
          </div>
        ...
        <div className="container px-4 md:px-6">
          <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-500 md:text-lg">
                As staking rewards are earned, the value of $SUN increases
                relative to Bitcoin. This means your $SUN becomes more valuable
                over time, reflecting both your initial stake and the
                accumulated rewards.
              </p>
              <div className="pt-4">
                <Link
          ...
          <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 md:grid-cols-2 lg:gap-12">
            <div className="rounded-lg border shadow-sm p-6">
              <h3 className="text-xl font-bold mb-2">
                What is the difference between regular staking and liquid
                staking?
              </h3>
              <p className="text-gray-500">
                Regular staking locks up your Bitcoin for a period of time,
                while liquid staking gives you a token ($SUN) that represents
                your staked Bitcoin, allowing you to use it in DeFi applications
            ...
            <div className="rounded-lg border shadow-sm p-6">
              ...
              <p className="text-gray-500">
                ...
                platform. There are two options: instant redemption via
                liquidity pools (may include a small fee) or standard redemption
            ...
            <div className="rounded-lg border shadow-sm p-6">
              ...
              <p className="text-gray-500">
                No, there is no minimum amount required for liquid staking. You
                can stake any amount of Bitcoin and receive the equivalent in
                $SUN.
              </p>
            </div>
            <div className="rounded-lg border shadow-sm p-6">
              <h3 className="text-xl font-bold mb-2">
                Where can I use my $SUN?
              </h3>
              <p className="text-gray-500">
                $SUN can be used in various DeFi applications within the Sundial
                ecosystem, including lending platforms, liquidity pools, and
            ...
            <div className="rounded-lg border shadow-sm p-6">
              ...
              <p className="text-gray-500">
                Staking rewards are automatically reflected in the increasing
                value of $SUN relative to Bitcoin. As rewards accrue, each $SUN
                becomes worth more Bitcoin.
              </p>
            </div>
            <div className="rounded-lg border shadow-sm p-6">
              <h3 className="text-xl font-bold mb-2">
              ...
              <p className="text-gray-500">
                Yes, Sundial&apos;s liquid staking solution is built with
                security as a priority. All staked Bitcoin is secured by our
                network of validators, and the $SUN token contract has been
        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="mx-auto max-w-[700px] text-gray-500 md:text-lg">
                Experience the benefits of staking while maintaining liquidity
                with Sundial&apos;s liquid staking solution.
              </p>
            </div>
            <Link
              href="/stake?type=liquid"
