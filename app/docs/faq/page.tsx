...
function Question({ q, a }: { q: string; a: React.ReactNode[] }) {
  return (
    <Card className="max-w-[800px] mx-auto mb-6">
...
function FAQSection({
  ...
  return (
    <Section className="px-12 md:px-24">
      <h2 className="max-w-[800px] text-2xl font-bold mx-auto mb-6">{title}</h2>
      <div>{children}</div>
    </Section>
  );
}
...
function UtxoSection() {
  return (
    <FAQSection title="UTXO Backend System Design">
      <Question
...
function BusinessModelSection() {
  return (
    <FAQSection title="Business Model & Revenue">
      <Question
...
function TechnicalFeasibilitySection() {
  return (
    <FAQSection title="Technical Feasibility">
      <Question
...
function RegulatorySection() {
  return (
    <FAQSection title="Regulatory & Compliance">
      <Question
...
function FinancialSection() {
  return (
    <FAQSection title="Financial Structure & Funding">
      <Question
