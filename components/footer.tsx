  ...
  return (
    ...
    <div className="container px-4 md:px-6">
      <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="space-y-4">
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li>
              <Link href="/docs/faq" className="text-gray-500 hover:text-gray-900">
                FAQ
              </Link>
            </li>
            <li>
              <Link href="/docs/guides" className="text-gray-500 hover:text-gray-900">
                Guides
              </Link>
            </li>
          </ul>
      ...
      <div className="mt-8 border-t pt-8 text-center text-sm text-gray-500">
        <p>© Copyright SUNDIAL {new Date().getFullYear()}. All rights reserved.</p>
      </div>
    </div>
  </footer>
  )
