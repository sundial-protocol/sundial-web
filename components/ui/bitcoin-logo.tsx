/**
 * The official Bitcoin mark, in two forms.
 *
 * Use these instead of lucide's `Bitcoin` icon: lucide draws its own line-art
...
/** The tilted "B", as it sits inside the disc. */
const B_PATH =
 ...
 * lucide icon does rather than floating in the empty space the disc left.
 */
export function BitcoinSymbol({ title, ...props }: LogoProps) {
  return (
    <svg
      width="24"
      height="24"
      viewBox="450.02 484.13 3048.31 3048.31"
    ...
    >
      ...
      <path fill="currentColor" fillRule="nonzero" d={B_PATH} />
    </svg>
  );
}
...
export function BitcoinLogo({ title, ...props }: LogoProps) {
  return (
    ...
    >
      ...
      />
      <path fill="white" fillRule="nonzero" d={B_PATH} />
    </svg>
  );
}
